...
bool ShowInventory(int client)
{
	...
	if (!ItemManager_FillCategories(menu, client, _, Menu_Inventory))
	{
		delete menu;
		return false;
	}
...
bool ShowCategories(int client)
{
	...
	if (!ItemManager_FillCategories(menu, client, _, Menu_Buy))
	{
		delete menu;
		return false;
	}
...
bool FillCategories(Menu menu, int source_client, bool showAll = false, ShopMenu shop_menu)
{
	return ItemManager_FillCategories(menu, source_client, showAll, shop_menu);
}
